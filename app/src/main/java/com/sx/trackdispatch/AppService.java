...
//    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://wildfirechat.net:8888";
    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://10.0.1.57:9000";
//    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "http://10.0.1.57:9000";
//    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "https://app.wildfirechat.net";
    ...
    public void smsLogin(String phoneNumber, String authCode) {

        String url = APP_SERVER_ADDRESS + "/oauth/token";
