...
public class ConversationListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        try {
            ...
            if(viewHolder.getRlParent()==null){
                viewHolder.setRlParent(itemView.findViewById(R.id.rl_parent));
            }
...
//        conversationInfos.get(0).conversation.
    }
...
//        itemView.setOnClickListener(viewHolder::onClick);
        ...
        if(itemClickListener!=null){
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    itemClickListener.itemClick(viewHolder.getLayoutPosition(),viewHolder.getConversationInfo());
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(viewHolder.getLayoutPosition()==selectPosition){
            viewHolder.getRlParent().setBackground(fragment.getResources().getDrawable(R.drawable.selector_common_item_select));
        }else{
            viewHolder.getRlParent().setBackground(fragment.getResources().getDrawable(R.drawable.selector_common_item));
        }
    }
    ...
    public interface ItemClickListener{
        void itemClick(int position,ConversationInfo conversationInfo);
    }
}
