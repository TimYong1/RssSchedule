...
public class ConversationFragment extends Fragment implements
    ...
    @OnClick(R2.id.imgvideo)
    void videoClick(){
        WfcUIKit.singleCall(this.getContext(), conversation.target, false);
    }

    @OnClick(R2.id.imgphoto)
    void photoClick(){
        WfcUIKit.singleCall(this.getContext(), conversation.target, true);
    }
    ...
    private void setTitle() {
        ...
        if(titleCallBack!=null){
            titleCallBack.getTitle(conversationTitle);
        }
        setActivityTitle(conversationTitle);
    }
