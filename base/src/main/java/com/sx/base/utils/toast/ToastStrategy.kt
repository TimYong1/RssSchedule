...
class ToastStrategy : Handler(Looper.getMainLooper()), IToastStrategy {
    ...
    /** 吐司队列  */
    @Volatile
    private var mQueue: Queue<CharSequence> = ArrayBlockingQueue(MAX_TOAST_CAPACITY)
    ...
    fun getToastDuration(text: CharSequence): Int {
        ...
        return if (text.length > 10) IToastStrategy.LONG_DURATION_TIMEOUT else IToastStrategy.SHORT_DURATION_TIMEOUT
    }

    companion object {

        /** 延迟时间  */
        private val DELAY_TIMEOUT = 300

        /** 显示吐司  */
        private val TYPE_SHOW = 1
        /** 继续显示  */
        private val TYPE_CONTINUE = 2
        /** 取消显示  */
        private val TYPE_CANCEL = 3
