...
import com.sx.hikvideo.jna.HCNetSDKByJNA;
...
public class DevManageGuider implements Serializable {
    ...
    public DeviceItem getCurrSelectDev(){
        m_iCurrSelectDevIndex = m_alDevList.size()-1;
     ...
     * @brief jna方式登陆设备
     */
    public DeviceItem login_v40_jna(String szDevName, DevNetInfo struDevNetInfo){
        // 验证参数有效性
